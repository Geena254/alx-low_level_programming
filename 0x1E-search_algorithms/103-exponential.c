...
/**
 * binary_search_helper - Function that searches for a value in an integer
 * array using a binary search algorithm, not guaranteed to return lowest index
 * if `value` appears twice in `array` (modified from `binary_search`)
